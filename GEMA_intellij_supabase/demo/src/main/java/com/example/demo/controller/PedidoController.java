...
public class PedidoController {
    ...
    public ResponseEntity<?> eliminarPedido(@PathVariable String id) {
        ...
        // Nota: Si borramos pedido, los detalles se borran en cascada si está configurado asi en JPA.
        // Si no, podría dar error. Asumiremos cascada o borrado manual si falla.
